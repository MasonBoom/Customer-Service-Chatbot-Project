...
class SupportBot:
  ...
  def welcome(self):
    name = input("Hi, I'm a customer support representative. Welcome to the Bank. Before we can help you, I need some information from you. What is your first name and last name? ")
  ...
  def how_to_pay_bill_intent(self):
    return input("You can pay your bill a couple of ways. 1) online at bill.bank.com or 2) you can pay your bill right now with me. Can I help you with anything else?")
